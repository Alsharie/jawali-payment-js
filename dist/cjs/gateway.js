...
class JawaliGateway {
    constructor(config) {
        ...
        this.axiosInstance = (0, axiosInstance_1.createAxiosInstance)(config.url.disableSslVerification);
    ...
    async login() {
        ...
        try {
            ...
            return new JawaliLoginResponse_1.default(responseJson);
        }
        catch (error) {
            return error;
        }
    ...
    async walletAuth() {
        ...
        try {
            ...
            return new JawaliWalletAuthResponse_1.default(responseJson);
        }
        catch (error) {
            return error;
        }
    ...
    async ecommerceInquiry(voucher, receiverMobile, purpose = '') {
        ...
        try {
            const responseJson = await this.sendRequest(`${this.config.url.base}/v1/ws/callWS`, this.attributes);
            return new JawaliEcommerceInquiryResponse_1.default(responseJson);
        }
        catch (error) {
            return error;
        }
    ...
    async ecommcaShout(voucher, receiverMobile, purpose = '') {
        ...
        try {
            const responseJson = await this.sendRequest(`${this.config.url.base}/v1/ws/callWS`, this.attributes);
            return new JawaliEcommcaShoutResponse_1.default(responseJson);
        }
        catch (error) {
            return error;
        }
    ...
    async sendRequest(url, data, useFormUrlEncoded = false) {
        ...
        try {
            ...
            if (errorMsg.includes('invalid access token') || errorMsg.includes('access token expired')) {
                throw new JawaliErrorResponse_1.default('Token error', 401);
            }
            return jsonData;
        }
        catch (error) {
            (0, console_1.log)('------------------------');
            (0, console_1.log)('Request error:', ((_a = error.response) === null || _a === void 0 ? void 0 : _a.data) || error.message);
            return new JawaliErrorResponse_1.default(((_b = error.response) === null || _b === void 0 ? void 0 : _b.data) || error.message, (_c = error.response) === null || _c === void 0 ? void 0 : _c.status);
        }
    }
    async refreshTokens() {
        try {
            const loginResponse = await this.login();
            if (loginResponse instanceof JawaliLoginResponse_1.default) {
                try {
